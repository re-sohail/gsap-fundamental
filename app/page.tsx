...
const BUTTONS_INFO = [
  ...
  },
  {
    label: 'Gsap From',
    href: '/gsap/from',
    description: 'Animate a property from a starting value to its current value.',
    icon: 'from',
  },
  {
    label: 'Gsap From To',
      ...
      <main className="flex min-h-screen items-center justify-center px-4">
        <div className="space-y-10 text-center">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-bold tracking-tight">Gsap Fundamentals</h1>
            <p className="text-muted-foreground mx-auto max-w-md text-base">
              Learn the fundamentals of Gsap and how to use it to create animations.
            </p>
          </div>
